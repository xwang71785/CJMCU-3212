...
和其它的NodeMCU不一样，NodeMCU(ESP8266)通常会在板上集成串口通信芯片如CP2012等。这样就可以直接用Arduino IDE选NodeMCU1.0板卡类别，对ESP8266刷code。而CJMCU没有专门的串口芯片，而是通过Step1.ino代码使ATmega32U4成为中继，所以只能用NodeMCU-Flasher来刷code
